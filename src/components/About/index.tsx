          ...
          <ul className={styles['about__items']}>
            <li className={`${styles['about__item']} ${styles['about__item--delivery']}`}>
              <p className={styles['about__text']}>
                Доставка осуществляется курьерской службой "Новая Почта" наложенным платежом или по полной предоплате на
                банковскую карту.
              </p>
            </li>
            ...
            <li className={`${styles['about__item']} ${styles['about__item--clock']}`}>
              <p className={styles['about__text']}>Доставка от 1-го до 3-ех дней по всей територии Украины.</p>
            </li>
          </ul>
        </div>
        <div className={styles['about__inner']}>
          ...
          <ul className={styles['about__items']}>
            <li className={`${styles['about__item']} ${styles['about__item--box']}`}>
              <p className={styles['about__text']}>Товар полностью соотвествуют описанию и фото на сайте</p>
            </li>
            ...
            <li className={`${styles['about__item']} ${styles['about__item--check']}`}>
              <p className={styles['about__text']}>
                Перед отправкой товар проходит 100% проверку. Мы вернем вам деньги если что-то с вашим заказом будет не
                так.
              </p>
            </li>
